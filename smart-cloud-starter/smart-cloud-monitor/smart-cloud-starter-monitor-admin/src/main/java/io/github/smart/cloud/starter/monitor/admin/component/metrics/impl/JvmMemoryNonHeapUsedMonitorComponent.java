...
public class JvmMemoryNonHeapUsedMonitorComponent extends AbstractJvmMemoryUsedMonitorComponent {
    ...
    public Integer getPreHeatHour(String serviceName) {
        ...
        if (serviceInfos != null && serviceInfos.containsKey(serviceName)) {
            MetricItemAlertProperties<DataSize> metricItemAlert = serviceInfos.get(serviceName).getMetric().getNonHeap();
            if (metricItemAlert.getPreHeatHour() != null) {
                return metricItemAlert.getPreHeatHour();
            }
        }

        return monitorProperties.getMetric().getNonHeap().getPreHeatHour();
    }
    ...
    public Integer getKeepIncreasingCount(String serviceName) {
        ...
        return monitorProperties.getMetric().getNonHeap().getKeepIncreasingCount();
    }
    ...
    public DataSize getKeepIncreasingSpeedThreshold(String serviceName) {
        ...
        return monitorProperties.getMetric().getNonHeap().getKeepIncreasingSpeedThreshold();
    }
    ...
    public DataSize getThreshold(String serviceName) {
        ...
        return monitorProperties.getMetric().getNonHeap().getThreshold();
    }
